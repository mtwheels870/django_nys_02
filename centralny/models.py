...
class DeIpRange(models.Model):
    ...
    company_na = models.CharField(max_length=40, null=True)
    naics_code = models.CharField(max_length=8, null=True)
    organizati = models.CharField(max_length=40, null=True)
    srs_compan = models.CharField(max_length=40, null=True)
    srs_issuer = models.CharField(max_length=10, null=True)
    srs_latitu = models.CharField(max_length=20, null=True)
    srs_longit = models.CharField(max_length=20, null=True)
    srs_streng = models.CharField(max_length=3, null=True)
