...
class DeIpRange(models.Model):
    ...
    company_na = models.CharField(max_length=40)
    naics_code = models.CharField(max_length=8)
    organizati = models.CharField(max_length=40)
    srs_compan = models.CharField(max_length=40)
    srs_issuer = models.CharField(max_length=10)
    srs_latitu = models.CharField(max_length=20)
    srs_longit = models.CharField(max_length=20)
    srs_streng = models.CharField(max_length=3)
